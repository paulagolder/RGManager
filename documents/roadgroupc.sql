...
INSERT INTO `roadgroupc` (`roadgroupid`, `wardid`, `subwardid`, `name`, `households`, `electors`, `distance`, `priority`, `prioritygroup`, `divisionid`, `kml`, `minlat`, `maxlat`, `minlong`, `maxlong`, `midlat`, `midlong`, `note`) VALUES
